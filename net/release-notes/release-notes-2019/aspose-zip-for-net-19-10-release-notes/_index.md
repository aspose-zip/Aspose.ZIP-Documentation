...
type: docs
weight: 20
url: /net/aspose-zip-for-net-19-10-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.ZIP for .NET 19.10](https://downloads.aspose.com/zip/net/new-releases/aspose.zip-for-.net-19.10/).
...
| :- | :- | :- |
|ZIPNET-374|[7z archive composition implemented with LZMA compression](/zip/net/working-with-7z-archives/#workingwith7zarchives-7-ziparchivewithlzmacompression)|Enhancement|
